 ...
 */
class PurchaseCategoryView extends \App\Models\PurchaseCategoryView implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'name', 'color', 'parent', 'path', 'depth'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (PurchaseCategoryView $proxy) {

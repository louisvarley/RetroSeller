 ...
 */
class Expense extends \App\Models\Expense implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'name', 'amount', 'purchases', 'account', 'date'];
        }
     ...
     * {@inheritDoc}
     */
    public function setAccount(\App\Models\Account $account)
    {
    ...
    public function getProporationAmount()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getProporationAmount', []);

        return parent::getProporationAmount();
    }

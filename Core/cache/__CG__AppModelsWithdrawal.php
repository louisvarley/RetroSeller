 ...
 */
class Withdrawal extends \App\Models\Withdrawal implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'amount', 'description', 'date', 'account'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Withdrawal $proxy) {

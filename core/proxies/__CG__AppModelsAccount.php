 ...
 */
class Account extends \App\Models\Account implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'name', 'sales', 'withdrawals', 'expenses', 'buyout', 'color'];
        }
    ...
    public function getWithdrawals()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getWithdrawals', []);
